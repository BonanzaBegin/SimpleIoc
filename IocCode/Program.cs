...

{
    ...
    var testService1= provider.GetService<ITestService1>();
    var testService2= provider.GetService<ITestService2>();
    var testService3= provider.GetService<ITestService3>();
}
